...
<div class="row">
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
		<img src="<?= $dados['caminho']?>/disco.png" style="width:100%;box-shadow: -2px 2px 2px 2px rgba(0, 0, 0, 0.27);">
	</div>
	<div class="col-xs-12 col-md-8 col-sm-8 col-lg-10 dados-disco">
		...
		| <span><?= $dados['musicas']?> músicas</span> <button type="button" class="btn btn-xs btn-info" onclick="setFila($('#tbl_musicas').data('musicas'));addDiscoPlay(<?= $dados['id']?>);"><i class="fa fa-play"></i> TOCAR TUDO</button>
		<button type="button" class="btn btn-xs btn-default" onclick="addFila($('#tbl_musicas').data('musicas'));addDiscoPlay(<?= $dados['id']?>);"><i class="fa fa-plus"></i> ADICIONAR À FILA</button>
	</div>
	<div class="col-xs-12">
